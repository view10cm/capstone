...
<body class="bg-[#F5F5F5] min-h-screen">
    ...
    <nav class="bg-[#2B2B2B] text-white px-6 py-4 flex items-center justify-between">
        ...
        <div class="flex items-center space-x-3">
            ...
            <div class="w-8 h-8 bg-orange-500 rounded-sm flex items-center justify-center">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" class="text-white">
                    <path d="M2 21h18v-2H2v2zm1.45-5h12.9c.75 0 1.36-.61 1.36-1.36V5c0-.75-.61-1.36-1.36-1.36H3.45C2.7 3.64 2.09 4.25 2.09 5v9.64c0 .75.61 1.36 1.36 1.36zM4 5h11v9H4V5zm16.5 2c-.28 0-.5.22-.5.5v6c0 .28.22.5.5.5s.5-.22.5-.5v-6c0-.28-.22-.5-.5-.5z"/>
                </svg>
            </div>
        ...
        <div class="mr-16">
            <button class="bg-orange-500 hover:bg-orange-600 transition-colors duration-200 text-white px-6 py-2 rounded-md font-medium">
                Order Tracker
            </button>
        </div>
